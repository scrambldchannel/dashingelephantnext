...
Annoyed at often forgetting some of this, I thought I'd try to list bit sof my workflow here so that I could refer back to it in future.
...
Just pull the latest installer from [their website](https://www.anaconda.com/download). Download the appropriate bundle for your OS and architecture and follow the installation instructions. I am exclusively using the 3.7 distribution and don't have any legacy code I depend on for my projects.
