...
I was focused on finding a tool that supported BigQuery's flavour of SQL but [SQLFluff](https://www.sqlfluff.com/) has dialect support for Snowflake, Redhsift, Postgres, and many more. 
