...
date: 2021-02-14
summary: It's the 14th of February so rather than buying any useless stuff I don't need for a fake holiday, I thought I'd play with a charting library.
draft: true # mark as draft until I can make this work
tags:
  - mermaid
  - markdown
  - chart
...
> [!WARNING]
> The display of charts in this old post relied on a Gridsome plugin and I'm to find a way to do the same in Next.js.

## Charts as code sounds lovely
