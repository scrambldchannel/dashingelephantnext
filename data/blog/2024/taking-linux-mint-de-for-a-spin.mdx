...
So Canonical's move to use Snaps, even when you `apt install` something, is something I would rather move away from. That said, I'm not a zealot, I want something that works more than I care about an ideology. If a particular piece of software I want could only be installed via a Snap (or a Flatpak etc), I wouldn't necessarily care that much. However, I want to avoid this extra complexity and bloat, to the extent I can. Still, I'd be lying if I didn't like using a community-driven distro if possible.
